...
namespace University_Management_System_2
{
    public partial class Salaries : Form
    {
        ...
        private void GetFacultyInfo()
        {
            ...
            {
                Connection.Open();
                string Query = "Select * from FakulteTbl where F_Id = " + Salary_FIdCb.SelectedValue.ToString() + " ";
                ...
                {
                    Salary_FNameTb.Text = dataRow["İsim"].ToString();
                    SalDeptTb.Text = dataRow["Bolum"].ToString();
                }
                Connection.Close();
            }
            catch (Exception e)
        ...
        private void Display()
        {
            ...
            try
            {
                DataTable data = new DataTable();
                Connection.Open();
                SqlDataAdapter adapter = new SqlDataAdapter("Select * from MaasTbl", Connection);
                adapter.Fill(data);
        ...
        private void PayBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Connection.Open();
                    SqlCommand cmd = new SqlCommand("Insert into MaasTbl(F_Id,F_ismi,Maas,Bolum,sonödemetarihi)values(@FId,@FN,@Sal,@Dept,@Date)", Connection);
        ...
        private void ResetBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Connection.Open();
                    SqlCommand cmd = new SqlCommand("Delete from MaasTbl where Maas_Id=@SKey", Connection);
