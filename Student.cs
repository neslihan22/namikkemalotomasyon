    ...
    public partial class Student : Form
    {
        ...
        private void GetDeptId() 
        {
            try
            {
                ...
                data.Load(Reader);
                St_DeptIdCb.ValueMember = "BolumId";
        ...
        private void GetDeptName() 
        {
            ...
            {
                Connection.Open();
                string Query = "Select * from BolumTbl where BolumId = " + St_DeptIdCb.SelectedValue.ToString() + " ";
                ...
                {
                    St_DeptTb.Text = dataRow["İsim"].ToString();
                }
                Connection.Close();
            }
            catch (Exception e)
        ...
        private void Display()
        {
            try
            {
                DataTable data = new DataTable();
                Connection.Open();
                SqlDataAdapter adapter = new SqlDataAdapter("select * from OgrenciTbl", Connection);
                adapter.Fill(data);
        ...
        private void SaveBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Connection.Open();
                    SqlCommand cmd = new SqlCommand("Insert into OgrenciTbl(Adı,İsebaslamatarihi,Cinsiyet,Adres,BolumId,Bolum,Telefon,Dönem)values(@SN,@SDOB,@SGen,@SAdd,@SDeptId,@SDept,@SPh,@Sem)", Connection);
        ...
        private void DeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Connection.Open();
                    SqlCommand cmd = new SqlCommand("Delete from OgrenciTbl where OgrenciId=@StKey", Connection);
        ...
        private void EditBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Connection.Open();
                    SqlCommand cmd = new SqlCommand("Update StudentTbl Set Adı=@SN,İsebaslamatarihi=@SDOB,Cinsiyet=@SGen,Adres=@SAdd,BolumId=@SDeptId,Bolum=@SDept,Telefon=@SPh,Dönem=@Sem where OgrenciId=@SKey", Connection);
                    cmd.Parameters.AddWithValue("@SN", StNameTb.Text);
                    cmd.Parameters.AddWithValue("@SDOB", StDOBdt.Value.Date);
                    cmd.Parameters.AddWithValue("@SGen", StGenderCb.SelectedItem.ToString());
                    cmd.Parameters.AddWithValue("@SAdd", StAddressTb.Text);
