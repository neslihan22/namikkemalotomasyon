...
namespace University_Management_System_2
{
    public partial class Fees : Form
    {
        ...
        private void GetStudentId()
        {
            ...
            {
                Connection.Open();
                SqlCommand cmd = new SqlCommand("Select OgrenciId from OgrenciTbl", Connection);
                SqlDataReader Reader = cmd.ExecuteReader();
                DataTable data = new DataTable();
                data.Columns.Add("OgrenciId", typeof(int));
                data.Load(Reader);
                StIdCb.ValueMember = "OgrenciId";
        ...
        private void GetStudentInfo()
        {
            ...
            {
                Connection.Open();
                string Query = "Select * from OgrenciTbl where OgrenciId = " + StIdCb.SelectedValue.ToString() + " ";
                ...
                {
                    StNameTb.Text = dataRow["Adı"].ToString();
                    StDeptTb.Text = dataRow["Bolum"].ToString();
                }
                Connection.Close();
            }
            catch (Exception e)
        ...
        private void Display()
        {
            ...
            try
            {
                DataTable data = new DataTable();
                Connection.Open();
                SqlDataAdapter adapter = new SqlDataAdapter("select * from YillikHarcTbl", Connection);
                adapter.Fill(data);
        ...
        private void PayBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Connection.Open();
                    SqlCommand cmd = new SqlCommand("Insert into YillikHarcTbl(OgrenciId,Ogrenciİsmi,OgrenciBolum,Donem,Toplamucret,Sontarih)values(@SId,@SN,@SDep,@Sem,@Amount,@Date)", Connection);
                    ...
                    cmd.Parameters.AddWithValue("@Amount", AmountTb.Text.ToString());
        ...
        private void ResetBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Connection.Open();
                    SqlCommand cmd = new SqlCommand("Delete from YillikHarcTbl where YillikHarc_Id=@FKey",Connection);
