    ...
    public partial class Campus : Form
    {
        ...
        private void Display()
        {
            try
            {
                ...
                Connection.Open();
                SqlDataAdapter adapter = new SqlDataAdapter("select * from KampusTbl", Connection);
                adapter.Fill(data);
            ...
            {
                MessageBox.Show(e.Message, "üniversite yönetim", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        private void Reset()
        {
        ...
        private void SaveBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Connection.Open();
                    SqlCommand cmd = new SqlCommand("Insert into KampusTbl(İsim,Sehir,Dekan,Derece,Katılım_Tarihi)values(@CN,@City,@Dir,@Rank,@Date)", Connection);
                    ...
                    cmd.ExecuteNonQuery();
                    DialogBox Db = new DialogBox("Hoca Eklendi");
                    Db.ShowDialog();
                    Connection.Close();
                    Display();
                }
        ...
        private void EditBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Connection.Open();
                    SqlCommand cmd = new SqlCommand("Update KampusTbl Set İsim=@CN,Sehir=@City,Dekan=@Dir,Derece=@Rank,Katılım_Tarihi=@Date where Kampus_Id=@CKey", Connection);
                    cmd.Parameters.AddWithValue("@CN", Camp_NameTb.Text);
                    cmd.Parameters.AddWithValue("@City", Camp_CityTb.Text);
                    cmd.Parameters.AddWithValue("@Dir", Camp_DirTb.Text);
                    cmd.Parameters.AddWithValue("@Rank", Dir_RankTb.Text);
                    ...
                    cmd.ExecuteNonQuery();
                    DialogBox Db = new DialogBox("Hoca bilgileri güncellendi");
                    Db.ShowDialog();
                    Connection.Close();
                    Display();
                }
        ...
        private void DeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Connection.Open();
                    SqlCommand cmd = new SqlCommand("Delete from KampusTbl where Kampus_Id=@CKey", Connection);
                    cmd.Parameters.AddWithValue("@CKey", Key);
                    cmd.ExecuteNonQuery();
                    DialogBox Db = new DialogBox("Hoca bilgileri silindi");
                    Db.ShowDialog();
                    Connection.Close();
                    Display();
                }
